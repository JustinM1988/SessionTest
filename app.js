// app.js — zero-dependency PKCE for ArcGIS (hardened)
...
function isExpired(sess) {
  ...
  return !sess?.access_token || (sess.expires_at && (sess.expires_at - now < 60));
}
...
async function whoAmI() {
  ...
  if (isExpired(sess)) { setStatus("signing in…"); return startLogin(); }
